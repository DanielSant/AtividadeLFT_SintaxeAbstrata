...
class SemanticVisitor(AbstractVisitor):
    ...
    def visitFuncDeclConcrete(self, funcDeclConcreta):
        funcDeclConcreta.signature.accept(self)
        funcDeclConcreta.body.accept(self)

    def visitSignatureConcrete(self, signatureConcreta):
        params = {}
    ...
    def visitPotExp(self, potExp):
        ...
        if (c == None):
            ...
            print('\n\t[Erro] Potenciacao invalida. A expressao ', end='')
